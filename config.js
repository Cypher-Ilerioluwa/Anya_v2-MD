...
module.exports = {
     ...
     */
    botname: process.env.BotName || "ÀKÀNDÉ-MIDÉ-BOT🤖🌹🍀",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 ÀKÀNDÉ-MIDÉ-BOT🤖🌹🍀",
    ...
    ownernumber: process.env.Owner_Number || "2349121881343",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "CYPHER🌚🌙",
    ...
    sessionId: process.env.SESSION_ID || "OtHD8u4Mk_A_N_Y_A_V_2_6mTJS24mfdo",
